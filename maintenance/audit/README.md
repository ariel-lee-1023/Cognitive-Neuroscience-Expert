...
| Stocco | Equations, measurement interpretation | Flag the advantage sign convention against its prose and the logged-axis description of exponential decay. These need targeted mathematical/source correction before numerical reuse; the new demos implement neither passage. |
